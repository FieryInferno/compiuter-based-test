...
<section class="content">
    <div class="callout callout-info">
        <h4>Informasi</h4>
        <p>
            Selamat datang di Halaman Login Aplikasi Computer Based Test (CBT) Politeknik Negeri Subang. Untuk memulai silahkan melakukan 
            proses Login dengan menggunakan username dan password yang sudah dimiliki.
        </p>
    </div>
    <center><img src="<?php echo base_url(); ?>/public/images/polsub.png" width="167" height="157" /></img></center><br />
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title"><center>Login Operator</center></h3>
                </div><!-- /.box-header -->
                <!-- form start -->
